...
@NamedQueries({
    ...
    @NamedQuery(name = "ProduseDB.findByProdus", query = "SELECT p FROM ProduseDB p WHERE p.produs = :produs")})
public class ProduseDB implements Serializable {
    ...
    public ProduseDB(Integer id, String produs) {
        this.id = id;
        this.produs = produs;
    }
